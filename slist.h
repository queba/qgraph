...
SList *slist_delete	(SList *slist, void (*delete_fct) (void *item));
void *	slist_remove	(SList **phead, SListCallback *find,
				 void *matchdata);
SList *slist_reverse	(SList *slist);
SList *slist_sort	(SList *slist, SListCompare *compare,
				 void *userdata);

SList *slist_tail	(SList *slist);
SList *slist_nth	(SList *slist, size_t n);
void *	slist_find	(SList *slist, SListCallback *find,
				 void *matchdata);
size_t slist_length	(SList *slist);

void *	slist_foreach   (SList *slist, SListCallback *foreach,
				 void *userdata);
